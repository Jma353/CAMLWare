...
(* OASIS_START *)
(* DO NOT EDIT (digest: 3cf473bacc70a4b8a4c4537be3c46dca) *)
(*
...
let setup_t =
  {
     ...
     build = OCamlbuildPlugin.build ["-use-ocamlfind"; "-use-menhir"];
     test = [];
     doc = [];
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "gui.ml"})
            ];
     ...
     oasis_version = "0.4.7";
     oasis_digest = Some "\154\016\177G5%\180\173\011z\192\006\176$\156\236";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
